...
void loop() {
  ...
  if (button0.fallingEdge()) {
    Keyboard.println("Red press");
  }
  if (button1.fallingEdge()) {
    Keyboard.println("Orange press");
  }
  if (button2.fallingEdge()) {
    Keyboard.println("Yellow press");
  }
  if (button3.fallingEdge()) {
    Keyboard.println("Green press");
  }
  if (button4.fallingEdge()) {
    Keyboard.println("Blue press");
  }
  if (button5.fallingEdge()) {
    Keyboard.println("VioletB9 release
    B0 rpress");
  }
